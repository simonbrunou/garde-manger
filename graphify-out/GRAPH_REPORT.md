...
## Corpus Check
- 167 files · ~140,688 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2829 nodes · 3740 edges · 289 communities (259 shown, 30 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 86 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `2940bc09`
...
Cohesion: 0.05
Nodes (33): @simplewebauthn/browser, statusText, teardown(), tick(), handleEnroll(), $app/environment, isPasskeyCancellation(), barcode-detector/ponyfill (+25 more)

### Community 1 - "Frontend Lib Imports & Passkeys"
Cohesion: 0.08
Nodes (36): makeDb(), testDb, createDb(), DB, runMigrations(), credentials, households, makeDb() (+28 more)
...
Cohesion: 0.07
Nodes (38): POST(), deleteSubscriptionByEndpoint, saveSubscription, cron module, secretMatches(), cron test, buildDailyPayload(), byteLength() (+30 more)

### Community 7 - "Household Admin CRUD"
Cohesion: 0.07
Nodes (31): BarcodeScanner component, CONTENT_TYPE_BY_EXT, GET(), gtinCheckDigit(), isValidBarcode(), normalizeBarcode(), makeUpce(), upcEToUpcA() (+23 more)

### Community 8 - "Home Inventory Listing"
Cohesion: 0.11
Nodes (33): load(), (app) layout component, actions, addPackagedSchema, load(), locationSchema, memberships, actions (+25 more)

### Community 9 - "Inventory-Items FK Schema"
Cohesion: 0.09
Nodes (29): actions, addCustomSchema, addFreshSchema, load(), locationSchema, add page component, { db, sqlite }, foods (+21 more)
...
Cohesion: 0.11
Nodes (26): POST /api/push/subscribe, POST /api/push/unsubscribe, OfflineBanner component, PushSettings component, m(), acceptInvitation, createInvitation, InvitationError (+18 more)
...
Cohesion: 0.14
Nodes (24): load(), products, actions, Groups, load(), Location, activeHouseholdId(), load() (+16 more)
...
Cohesion: 0.11
Nodes (20): ItemRow, categoryIcon, dayBadge(), dates tests, NOW, categoryIcon(), MAP, icons tests (+12 more)
...
Cohesion: 0.11
Nodes (19): memberships_household_id_households_id_fk, memberships_household_id_user_id_unique, checkConstraints, compositePrimaryKeys, foreignKeys, columnsFrom, columnsTo, name (+11 more)
...
Cohesion: 0.13
Nodes (14): dialect, checkConstraints, compositePrimaryKeys, foreignKeys, indexes, name, uniqueConstraints, id (+6 more)
...
Cohesion: 0.15
Nodes (13): device_label, public_key, columns, autoincrement, name, notNull, primaryKey, type (+5 more)
...
Cohesion: 0.18
Nodes (11): memberships_household_id_user_id_unique, checkConstraints, compositePrimaryKeys, columns, isUnique, name, indexes, name (+3 more)
...
Cohesion: 0.22
Nodes (9): POST /api/webauthn/authenticate/options, POST /api/webauthn/authenticate/verify, POST /api/webauthn/register/options, POST /api/webauthn/register/verify, PasskeyEnroll component, PasskeyLogin component, Login Page Component, load() (+1 more)
...
Cohesion: 0.22
Nodes (9): memberships_user_id_users_id_fk, foreignKeys, columnsFrom, columnsTo, name, onDelete, onUpdate, tableFrom (+1 more)
...
Cohesion: 0.36
Nodes (5): loginSchema, safeLocalPath(), signupSchema, actions, load()
...
Cohesion: 0.29
Nodes (7): last_used_at, columns, autoincrement, name, notNull, primaryKey, type
...
Cohesion: 0.6
Nodes (3): load(), Bilan page, householdStats()
...
- **Why does `columns` connect `Schema col: counter` to `Schema col: households`, `Schema col: foods`, `Schema col: invitations`, `Inventory-Items FK Schema (mig)`, `Schema col: food_id`, `Schema col: use_by_date`, `Schema col: notes`, `Schema col: created_at`, `Schema col: credential_id`, `Schema col: device_label`, `Schema col: household_id`, `DB Schema Fragment`, `Schema col: last_used_at`, `Schema col: public_key`, `Invite & Join Flow`, `Schema col: created_by`, `Schema col: used_at`?**
  _High betweenness centrality (0.012) - this node is a cross-community bridge._
- **Why does `svelte` connect `Push & Daily-Reminder Cron` to `Invitations FK Schema (mig)`?**
  _High betweenness centrality (0.011) - this node is a cross-community bridge._
- **Why does `devDependencies` connect `Invitations FK Schema (mig)` to `Schema col: token_hash`?**
  _High betweenness centrality (0.011) - this node is a cross-community bridge._
