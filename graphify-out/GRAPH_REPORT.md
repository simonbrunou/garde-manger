...
## Corpus Check
- 173 files · ~141,866 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2829 nodes · 3739 edges · 291 communities (261 shown, 30 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 86 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `385e13dd`
...
Cohesion: 0.05
Nodes (30): @simplewebauthn/browser, statusText, teardown(), tick(), handleEnroll(), $app/environment, isPasskeyCancellation(), barcode-detector/ponyfill (+22 more)
...
Cohesion: 0.1
Nodes (33): makeDb(), testDb, createDb(), runMigrations(), { db, sqlite }, foods, makeDb(), makeDb() (+25 more)

### Community 7 - "Household Admin CRUD"
Cohesion: 0.08
Nodes (38): POST(), deleteSubscriptionByEndpoint, saveSubscription, cron module, runDailyReminders(), secretMatches(), cron test, buildDailyPayload() (+30 more)

### Community 8 - "Home Inventory Listing"
Cohesion: 0.1
Nodes (23): createSession(), randomId(), sha256(), validateSessionToken(), DB, credentials, households, inventoryItems (+15 more)

### Community 9 - "Inventory-Items FK Schema"
Cohesion: 0.11
Nodes (31): load(), (app) layout component, load(), Bilan page, actions, load(), Households list page, actionHousehold() (+23 more)
...
Cohesion: 0.16
Nodes (22): products, actions, Groups, load(), Location, activeHouseholdId(), load(), listPendingInvitations (+14 more)
...
Cohesion: 0.16
Nodes (20): invitations, Household manage hub actions, acceptInvitation, createInvitation, InvitationError, revokeInvitation, Invite create action, acceptInvitation() (+12 more)

### Community 19 - "Invitations FK Schema (mig)"
Cohesion: 0.11
Nodes (19): ItemRow, categoryIcon, dayBadge(), dates tests, NOW, categoryIcon(), MAP, icons tests (+11 more)
...
Cohesion: 0.21
Nodes (14): clearSessionCookie(), setSessionCookie(), invalidateSession(), verifyAuthentication(), clearSessionCookie, SESSION_COOKIE constant, setSessionCookie, POST() (+6 more)
...
Cohesion: 0.15
Nodes (13): autoincrement, name, notNull, primaryKey, type, categories, image_path, autoincrement (+5 more)
...
Cohesion: 0.2
Nodes (8): addCustomSchema, addFreshSchema, locationSchema, ./$types, catalogue module, searchFoods(), catalogue test, seedFoods
...
Cohesion: 0.44
Nodes (6): resolveLocale(), normalizeChoice(), resolveTheme(), theme tests, ThemeChoice, handle()
...
Cohesion: 0.33
Nodes (7): POST /api/push/subscribe, POST /api/push/unsubscribe, BarcodeScanner component, OfflineBanner component, PushSettings component, i18n m (message resolver), BottomNav component
...
Cohesion: 0.29
Nodes (7): checkConstraints, compositePrimaryKeys, indexes, name, uniqueConstraints, tables, sessions
...
- **Why does `columns` connect `Package Metadata` to `Schema col: created_at`, `FK: sessions user id users id fk`, `DB Schema Fragment`, `Schema col: email`, `Schema col: food_id`, `Schema col: kind`, `Schema col: use_by_date`, `Schema col: location`, `Schema col: created_at`, `Schema col: credential_id`, `Schema col: device_label`, `Account & Credentials Page`, `DB Schema Fragment`, `Schema col: last_used_at`, `Schema col: household_id`, `Schema col: display_name`, `Schema col: image_path`?**
  _High betweenness centrality (0.012) - this node is a cross-community bridge._
- **Why does `svelte` connect `Push & Daily-Reminder Cron` to `Dev Dependencies & Tooling`?**
  _High betweenness centrality (0.010) - this node is a cross-community bridge._
- **Why does `devDependencies` connect `Dev Dependencies & Tooling` to `Schema col: closed_at`?**
  _High betweenness centrality (0.010) - this node is a cross-community bridge._
