...
## Corpus Check
- 173 files · ~142,102 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2829 nodes · 3740 edges · 290 communities (260 shown, 30 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 86 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `5a4a7afc`
...
Cohesion: 0.05
Nodes (31): @simplewebauthn/browser, statusText, teardown(), tick(), handleEnroll(), $app/environment, isPasskeyCancellation(), barcode-detector/ponyfill (+23 more)
...
Cohesion: 0.09
Nodes (30): deleteSubscriptionByEndpoint, saveSubscription, byteLength(), COPY, DailyCopy, deleteSubscriptionByEndpoint(), incrementFailure(), isEndpointSendable() (+22 more)
...
Cohesion: 0.12
Nodes (17): POST(), pushSubscriptions, cron module, DailyReminderSummary, runDailyReminders(), secretMatches(), cron test, FakeSender (+9 more)

### Community 15 - "Memberships FK Schema (mig)"
Cohesion: 0.19
Nodes (10): DB, credentials, households, inventoryItems, sessions, users, NOW, TODAY_START (+2 more)
...
Cohesion: 0.22
Nodes (16): load(), Bilan page, load(), households module, countAdmins(), createHousehold(), deleteHousehold(), HouseholdError (+8 more)
...
Cohesion: 0.17
Nodes (17): makeDb(), testDb, createDb(), runMigrations(), makeDb(), products, makeDb(), makeDb() (+9 more)

### Community 23 - "Deploy & Security Architecture"
Cohesion: 0.16
Nodes (22): BottomNav app shell (5-slot tab bar + FAB), categoryIcon() category→IconName mapping, dayBadge() + DayBadge urgency badge, computeBestBy DDM estimate, Generated effective_date column (coalesce DLC/DDM), Hand-rolled FR/EN i18n + resolveLocale, householdStats() anti-waste aggregation, FR/EN i18n key parity test (+14 more)
...
Cohesion: 0.23
Nodes (16): load(), activeHouseholdId(), addCustom(), addFresh(), addPackaged(), bandFor(), deleteItem(), getItem() (+8 more)
...
Cohesion: 0.16
Nodes (15): load(), (app) layout component, actions, actionHousehold(), Household manage hub actions, ensureAdmin(), fixActiveHousehold(), load() (+7 more)
...
Cohesion: 0.16
Nodes (13): POST /api/push/subscribe, POST /api/push/unsubscribe, BarcodeScanner component, OfflineBanner component, PushSettings component, load(), Households list page, m() (+5 more)

### Community 34 - "Schema col: household_id"
Cohesion: 0.21
Nodes (13): actions, load(), account page component, listCredentials(), normalizeChoice(), resolveTheme(), theme tests, ThemeChoice (+5 more)
...
Cohesion: 0.16
Nodes (11): actions, Groups, ItemRow, Location, dayBadge(), dates tests, NOW, Band (+3 more)
...
Cohesion: 0.15
Nodes (13): default_location, name_en, autoincrement, name, notNull, primaryKey, type, columns (+5 more)
...
Cohesion: 0.26
Nodes (7): loginSchema, safeLocalPath(), signupSchema, actions, load(), ./$types, load()
...
Cohesion: 0.22
Nodes (9): memberships_household_id_households_id_fk, foreignKeys, columnsFrom, columnsTo, name, onDelete, onUpdate, tableFrom (+1 more)
...
Cohesion: 0.4
Nodes (5): acceptInvitation, createInvitation, InvitationError, revokeInvitation, Invite create action
...
- **Why does `columns` connect `DB Schema Fragment` to `Schema col: created_at`, `Schema col: email`, `Household Admin CRUD`, `Schema col: device_label`, `Schema col: food_id`, `Schema col: device_label`, `Schema col: household_id`, `DB Schema Fragment`, `Schema col: public_key`, `Schema col: role`, `Schema col: created_by`, `Schema col: used_at`, `Schema col: brand`, `Schema col: categories`, `Schema col: image_path`, `Schema col: closed_at`, `Schema col: counter`?**
  _High betweenness centrality (0.012) - this node is a cross-community bridge._
- **Why does `svelte` connect `Push & Daily-Reminder Cron` to `Invitations FK Schema (mig)`?**
  _High betweenness centrality (0.011) - this node is a cross-community bridge._
- **Why does `devDependencies` connect `Invitations FK Schema (mig)` to `Schema col: expires_at`?**
  _High betweenness centrality (0.011) - this node is a cross-community bridge._
