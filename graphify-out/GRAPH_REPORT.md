# Graph Report - garde-manger  (2026-06-03)

## Corpus Check
- 171 files · ~154,074 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2844 nodes · 3770 edges · 295 communities (264 shown, 31 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 88 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `ba6b50ba`
...
- [[_COMMUNITY_Schema col load()|Schema col: load()]]
...
- [[_COMMUNITY_Schema col vite.config.ts|Schema col: vite.config.ts]]
- [[_COMMUNITY_Schema col drizzle.config.ts|Schema col: drizzle.config.ts]]
- [[_COMMUNITY_Schema col +layout.ts|Schema col: +layout.ts]]
- [[_COMMUNITY_Schema col +page.ts|Schema col: +page.ts]]
- [[_COMMUNITY_Schema col +layout.ts|Schema col: +layout.ts]]
- [[_COMMUNITY_Schema col +page.ts|Schema col: +page.ts]]
- [[_COMMUNITY_Schema col +page.ts|Schema col: +page.ts]]
- [[_COMMUNITY_Schema col +page.ts|Schema col: +page.ts]]
- [[_COMMUNITY_Schema col +page.ts|Schema col: +page.ts]]
- [[_COMMUNITY_Schema col index.ts|Schema col: index.ts]]
...
1. `createDb()` - 35 edges
2. `runMigrations()` - 34 edges
3. `requireMembership()` - 29 edges
4. `DB` - 25 edges
5. `devDependencies` - 24 edges
6. `users` - 23 edges
7. `withDb()` - 19 edges
8. `columns` - 18 edges
9. `columns` - 18 edges
...
- `gen-icons.py PWA icon generator` --shares_data_with--> `app.html shell`  [INFERRED]
  scripts/gen-icons.py → src/app.html
...
Cohesion: 0.06
Nodes (28): statusText, teardown(), tick(), barcode-detector/ponyfill, $lib/barcode, $lib/dates, $lib/i18n, $lib/icons (+20 more)

### Community 1 - "Frontend Lib Imports & Passkeys"
Cohesion: 0.06
Nodes (28): freshHousehold(), dedicatedHousehold(), ownerId(), useDedicatedHousehold(), isoDate(), utcMidnight(), getActiveItems(), getCredentialCount() (+20 more)
...
Cohesion: 0.08
Nodes (25): actions, addPackagedSchema, load(), locationSchema, ImageStore, LookupDeps, lookupProduct(), maybeDownloadImage() (+17 more)

### Community 6 - "DB Init & Test Fixtures"
Cohesion: 0.05
Nodes (37): display_name, email, locale, password_hash, autoincrement, name, notNull, primaryKey (+29 more)

### Community 7 - "Household Admin CRUD"
Cohesion: 0.13
Nodes (28): load(), products, actions, Groups, load(), Location, actionHousehold(), activeHouseholdId() (+20 more)
...
Cohesion: 0.1
Nodes (27): deleteSubscriptionByEndpoint, saveSubscription, COPY, DailyCopy, deleteSubscriptionByEndpoint(), incrementFailure(), isEndpointSendable(), isIpLiteral() (+19 more)

### Community 11 - "Scan / Item-Detail / Bilan Routes"
Cohesion: 0.15
Nodes (24): load(), load(), (app) layout component, load(), Bilan page, actions, load(), ensureAdmin() (+16 more)
...
Cohesion: 0.18
Nodes (12): DB, credentials, households, inventoryItems, memberships, sessions, users, NOW (+4 more)
...
Cohesion: 0.13
Nodes (20): foods, shelfLives, FOOD_SEED, FoodSeed, ShelfLifeSeed, seedFoods(), VALID_BASES, VALID_LOCATIONS (+12 more)

### Community 19 - "Invitations FK Schema (mig)"
Cohesion: 0.14
Nodes (21): invitations, Household manage hub actions, acceptInvitation, createInvitation, InvitationError, revokeInvitation, actions, Invite create action (+13 more)
...
Cohesion: 0.16
Nodes (18): makeDb(), testDb, createDb(), runMigrations(), makeDb(), makeDb(), makeDb(), pushSubscriptions (+10 more)

### Community 22 - "Session & Login/Signup Auth"
Cohesion: 0.15
Nodes (23): BottomNav app shell (5-slot tab bar + FAB), categoryIcon() category→IconName mapping, dayBadge() + DayBadge urgency badge, computeBestBy DDM estimate, Generated effective_date column (coalesce DLC/DDM), Hand-rolled FR/EN i18n + resolveLocale, householdStats() anti-waste aggregation, FR/EN i18n key parity test (+15 more)

### Community 23 - "Deploy & Security Architecture"
Cohesion: 0.11
Nodes (22): app.d.ts (App.Locals types), app.html shell, backup.ts script, Bilan anti-waste stats surface, Bottom tab bar + center FAB navigation, Coolify + Railpack self-hosting, Cuisiner (cook-what's-expiring) surface, CSS custom-property design tokens (+14 more)
...
Cohesion: 0.21
Nodes (14): Households list page, i18n index, Locale, m(), messages, i18n index test, Household manage hub page, load() (+6 more)
...
Cohesion: 0.12
Nodes (12): Barcode scan (BarcodeDetector + ZXing WASM), Declarative Web Push (visible, <3KB, no JS), Migration 0004 (push_subscriptions), gen-icons.py PWA icon generator, ASSET_SET, ASSETS, NETWORK_ONLY_PREFIXES, networkFirst() (+4 more)

### Community 29 - "i18n Messages"
Cohesion: 0.12
Nodes (17): scripts, build, check, check:watch, db:backup, db:generate, db:migrate, db:push (+9 more)
...
Cohesion: 0.23
Nodes (11): { db, sqlite }, CONTENT_TYPE_BY_EXT, GET(), gtinCheckDigit(), isValidBarcode(), normalizeBarcode(), makeUpce(), upcEToUpcA() (+3 more)
...
Cohesion: 0.26
Nodes (10): assertConfig(), authenticationOptions(), deleteCredential(), registrationOptions(), User, verifyRegistration(), POST(), POST() (+2 more)
...
Cohesion: 0.15
Nodes (13): last_used_at, transports, columns, autoincrement, name, notNull, primaryKey, type (+5 more)
...
Cohesion: 0.21
Nodes (12): Barcode normalize/validate (GTIN), Cache-first OFF lookup (1 scan ≤ 1 OFF call), Daily reminder cron (/internal/cron/check-expiry), CRON_SECRET constant-time gate, usersToNotify expiry aggregation, injectManifest service worker (offline view-only), iOS install gate + permission priming, ODbL separation (OFF data never in foods/shelf_lives) (+4 more)

### Community 69 - "Build & CSP Config"
Cohesion: 0.22
Nodes (11): POST /api/push/subscribe, POST /api/push/unsubscribe, BarcodeScanner component, OfflineBanner component, PushSettings component, ItemRow, i18n m (message resolver), Band (+3 more)

### Community 70 - "FK: sessions user id users id fk"
Cohesion: 0.35
Nodes (8): sha256(), validateSessionToken(), resolveLocale(), normalizeChoice(), resolveTheme(), theme tests, ThemeChoice, handle()
...
Cohesion: 0.29
Nodes (7): loginSchema, safeLocalPath(), signupSchema, actions, load(), load(), Signup Page Component
...
Cohesion: 0.27
Nodes (9): actions, load(), account page component, listCredentials(), vapidPublicKey, ./$types, vapidPublicKey(), deleteCredential (+1 more)

### Community 87 - "Invite & Join Flow"
Cohesion: 0.22
Nodes (5): @simplewebauthn/browser, handleEnroll(), $app/environment, isPasskeyCancellation(), ./$types
...
Cohesion: 0.22
Nodes (7): actions, addCustomSchema, addFreshSchema, locationSchema, add page component, addCustom, addFresh

### Community 92 - "Schema col: users"
Cohesion: 0.42
Nodes (6): GENERIC_IDEA, Idea, IDEAS, cook module, ideasForCategory(), cook test
...
Cohesion: 0.36
Nodes (6): clearSessionCookie(), invalidateSession(), clearSessionCookie, SESSION_COOKIE constant, POST(), invalidateSession
...
Cohesion: 0.25
Nodes (8): checkConstraints, compositePrimaryKeys, foreignKeys, indexes, name, uniqueConstraints, tables, households
...
Cohesion: 0.29
Nodes (7): POST /api/webauthn/authenticate/options, POST /api/webauthn/authenticate/verify, POST /api/webauthn/register/options, POST /api/webauthn/register/verify, PasskeyEnroll component, PasskeyLogin component, Login Page Component
...
Cohesion: 0.29
Nodes (7): custom_name, autoincrement, name, notNull, primaryKey, type, columns
...
Cohesion: 0.29
Nodes (7): public_key, columns, autoincrement, name, notNull, primaryKey, type
...
Cohesion: 0.38
Nodes (7): HouseholdError, Last-admin protection invariant, Manage household hub (Approach B), requireMembership authorization pattern, Type-to-confirm household delete guard, Household-admin CRUD Implementation Plan, Household-admin CRUD Design Spec

### Community 170 - "Schema col: food_id"
Cohesion: 0.47
Nodes (4): dayBadge(), formatDayBadge(), dates tests, NOW
...
### Community 248 - "Schema col: auth/webauthn module"
Cohesion: 0.5
Nodes (3): dialect, entries, version

## Knowledge Gaps
- **1781 isolated node(s):** `pixels: list of rows; each row a list of (r,g,b,a) tuples.`, `Fill the whole canvas with `color`, leaving rounded transparent corners.`, `Draw 'G' or 'M' inside the box (ox,oy)..(ox+cw,oy+ch) using strokes.`, `barcode-detector/ponyfill`, `active` (+1776 more)
...
- **Why does `en` connect `Seed Data & Health Check` to `Frontend Lib Imports & Passkeys`?**
  _High betweenness centrality (0.016) - this node is a cross-community bridge._
- **Why does `columns` connect `Schema col: created_at` to `Schema col: email`, `DB Schema Fragment`, `Home Inventory Listing`, `Schema col: device_label`, `Schema col: use_by_date`, `Schema col: location`, `Schema col: notes`, `Schema col: created_at`, `Schema col: credential_id`, `Schema col: household_id`, `Icon-Generation Script`, `Schema col: last_used_at`, `DB Schema Fragment`, `Schema col: role`, `Schema col: public_key`, `Schema col: used_at`, `Schema col: backed_up`?**
  _High betweenness centrality (0.014) - this node is a cross-community bridge._
- **Why does `svelte` connect `Push & Daily-Reminder Cron` to `Design System & UX Helpers`?**
