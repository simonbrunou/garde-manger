...
## Corpus Check
- 171 files · ~154,022 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2844 nodes · 3770 edges · 294 communities (263 shown, 31 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 88 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `10ff6507`
...
Cohesion: 0.07
Nodes (34): actions, addPackagedSchema, load(), locationSchema, products, CONTENT_TYPE_BY_EXT, GET(), gtinCheckDigit() (+26 more)
...
Cohesion: 0.12
Nodes (26): invitations, actions, Household manage hub actions, ensureAdmin(), fixActiveHousehold(), setHouseholdCookie(), acceptInvitation, createInvitation (+18 more)
...
Cohesion: 0.11
Nodes (19): POST(), pushSubscriptions, cron module, DailyReminderSummary, runDailyReminders(), secretMatches(), cron test, FakeSender (+11 more)

### Community 15 - "Memberships FK Schema (mig)"
Cohesion: 0.16
Nodes (23): actions, Groups, load(), Location, activeHouseholdId(), load(), listPendingInvitations, tipForItem() (+15 more)
...
Cohesion: 0.12
Nodes (21): foods, shelfLives, FOOD_SEED, FoodSeed, ShelfLifeSeed, main(), seedFoods(), VALID_BASES (+13 more)
...
Cohesion: 0.14
Nodes (15): load(), Bilan page, load(), { db, sqlite }, load(), Households list page, Household manage hub page, listActive (+7 more)
...
Cohesion: 0.2
Nodes (16): makeDb(), testDb, createDb(), runMigrations(), makeDb(), makeDb(), makeDb(), makeDb() (+8 more)

### Community 25 - "NPM Scripts"
Cohesion: 0.25
Nodes (14): load(), (app) layout component, actionHousehold(), households module, countAdmins(), createHousehold(), deleteHousehold(), HouseholdError (+6 more)
...
Cohesion: 0.24
Nodes (13): setSessionCookie(), createSession(), randomId(), User, verifyAuthentication(), verifyRegistration(), setSessionCookie, createSession (+5 more)
...
Cohesion: 0.24
Nodes (10): actions, load(), account page component, deleteCredential(), listCredentials(), vapidPublicKey, ./$types, vapidPublicKey() (+2 more)
...
Cohesion: 0.22
Nodes (8): actions, addCustomSchema, addFreshSchema, load(), locationSchema, add page component, addCustom, addFresh
...
Cohesion: 0.22
Nodes (9): invitations_household_id_households_id_fk, foreignKeys, columnsFrom, columnsTo, name, onDelete, onUpdate, tableFrom (+1 more)
...
Cohesion: 0.43
Nodes (6): assertConfig(), authenticationOptions(), registrationOptions(), POST(), POST(), POST()
...
Cohesion: 0.29
Nodes (7): created_at, autoincrement, name, notNull, primaryKey, type, columns
...
Cohesion: 0.29
Nodes (7): checkConstraints, compositePrimaryKeys, indexes, name, uniqueConstraints, tables, invitations
...
Cohesion: 0.29
Nodes (7): used_at, columns, autoincrement, name, notNull, primaryKey, type
...
- **Why does `en` connect `Migration 0001 Snapshot` to `Frontend Lib Imports & Passkeys`?**
  _High betweenness centrality (0.016) - this node is a cross-community bridge._
- **Why does `columns` connect `Logout & Session Clear` to `Package Metadata`, `Schema col: created_at`, `Schema col: email`, `Home Inventory Listing`, `Schema col: kind`, `Schema col: use_by_date`, `Schema col: location`, `Schema col: notes`, `Schema col: credential_id`, `Schema col: device_label`, `Schema col: household_id`, `DB Schema Fragment`, `Schema col: last_used_at`, `Schema col: public_key`, `Schema col: used_at`, `Schema col: categories`, `Schema col: users`?**
  _High betweenness centrality (0.014) - this node is a cross-community bridge._
- **Why does `svelte` connect `Push & Daily-Reminder Cron` to `Add-Item & DB Seed`?**
