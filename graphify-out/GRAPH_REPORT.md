...
Cohesion: 0.06
Nodes (46): POST(), pushSubscriptions, deleteSubscriptionByEndpoint, saveSubscription, cron module, DailyReminderSummary, runDailyReminders(), secretMatches() (+38 more)
...
Cohesion: 0.12
Nodes (26): makeDb(), testDb, createDb(), DB, runMigrations(), credentials, households, makeDb() (+18 more)

### Community 8 - "Home Inventory Listing"
Cohesion: 0.11
Nodes (32): load(), (app) layout component, load(), Bilan page, actions, load(), Households list page, actionHousehold() (+24 more)

### Community 9 - "Inventory-Items FK Schema"
Cohesion: 0.12
Nodes (29): addCustomSchema, addFreshSchema, locationSchema, load(), products, actions, Groups, load() (+21 more)
...
Cohesion: 0.11
Nodes (24): { db, sqlite }, foods, shelfLives, load(), FOOD_SEED, FoodSeed, ShelfLifeSeed, main() (+16 more)
...
Cohesion: 0.11
Nodes (21): app.d.ts (App.Locals types), app.html shell, Bilan anti-waste stats surface, Bottom tab bar + center FAB navigation, Coolify + Railpack self-hosting, Cuisiner (cook-what's-expiring) surface, CSS custom-property design tokens, DLC (hard use-by) vs DDM (best-before estimate) (+13 more)

### Community 24 - "Food Catalogue & Best-By"
Cohesion: 0.15
Nodes (14): POST /api/push/subscribe, POST /api/push/unsubscribe, BarcodeScanner component, OfflineBanner component, PushSettings component, i18n m (message resolver), loginSchema, safeLocalPath() (+6 more)
...
Cohesion: 0.29
Nodes (11): invitations, memberships, acceptInvitation(), createInvitation(), findByToken(), InvitationError, listPendingInvitations(), randomToken() (+3 more)
...
Cohesion: 0.19
Nodes (11): Household manage hub actions, acceptInvitation, createInvitation, InvitationError, revokeInvitation, Invite create action, ./$types, previewInvitation() (+3 more)
...
Cohesion: 0.2
Nodes (10): Barcode scan (BarcodeDetector + ZXing WASM), Daily reminder cron (/internal/cron/check-expiry), CRON_SECRET constant-time gate, Declarative Web Push (visible, <3KB, no JS), usersToNotify expiry aggregation, injectManifest service worker (offline view-only), iOS install gate + permission priming, Migration 0004 (push_subscriptions) (+2 more)
...
Cohesion: 0.29
Nodes (7): email, autoincrement, name, notNull, primaryKey, type, columns
...
Cohesion: 0.29
Nodes (7): notes, columns, autoincrement, name, notNull, primaryKey, type
...
- **Why does `en` connect `Schema col: created_at` to `Foods Catalogue Schema`?**
  _High betweenness centrality (0.017) - this node is a cross-community bridge._
- **Why does `columns` connect `Schema col: invitations` to `Logout & Session Clear`, `Package Metadata`, `Schema col: created_at`, `Schema col: best_by_date`, `Schema col: closed_at`, `Inventory-Items FK Schema (mig)`, `Schema col: location`, `Schema col: notes`, `Schema col: created_at`, `Schema col: credential_id`, `Schema col: device_label`, `DB Schema Fragment`, `Schema col: last_used_at`, `Schema col: public_key`, `Schema col: role`, `Schema col: created_by`, `Schema col: backed_up`?**
