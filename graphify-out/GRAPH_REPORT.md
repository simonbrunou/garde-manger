...
## Corpus Check
- 167 files · ~146,376 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2834 nodes · 3755 edges · 293 communities (263 shown, 30 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 87 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `0cc63cee`
...
## Communities (293 total, 30 thin omitted)
...
Cohesion: 0.08
Nodes (29): BarcodeScanner component, CONTENT_TYPE_BY_EXT, GET(), gtinCheckDigit(), isValidBarcode(), normalizeBarcode(), makeUpce(), upcEToUpcA() (+21 more)
...
Cohesion: 0.1
Nodes (26): deleteSubscriptionByEndpoint, COPY, DailyCopy, deleteSubscriptionByEndpoint(), incrementFailure(), isEndpointSendable(), isIpLiteral(), isPrivateOrLocalHost() (+18 more)
...
Cohesion: 0.15
Nodes (25): load(), actions, Groups, load(), Location, activeHouseholdId(), load(), listActive (+17 more)

### Community 11 - "Scan / Item-Detail / Bilan Routes"
Cohesion: 0.16
Nodes (14): DB, credentials, foods, households, inventoryItems, memberships, products, sessions (+6 more)
...
Cohesion: 0.11
Nodes (20): POST(), saveSubscription, cron module, DailyReminderSummary, runDailyReminders(), secretMatches(), cron test, FakeSender (+12 more)
...
Cohesion: 0.19
Nodes (18): load(), Bilan page, ensureAdmin(), load(), households module, countAdmins(), createHousehold(), deleteHousehold() (+10 more)
...
Cohesion: 0.21
Nodes (15): invitations, actions, acceptInvitation(), createInvitation(), findByToken(), InvitationError, listPendingInvitations(), previewInvitation() (+7 more)
...
Cohesion: 0.14
Nodes (15): actions, addCustomSchema, addFreshSchema, load(), locationSchema, add page component, load(), (app) layout component (+7 more)
...
Cohesion: 0.13
Nodes (15): autoincrement, name, notNull, primaryKey, type, categories, image_path, autoincrement (+7 more)
...
Cohesion: 0.21
Nodes (9): loginSchema, safeLocalPath(), signupSchema, actions, load(), Login Page Component, ./$types, load() (+1 more)
...
Cohesion: 0.21
Nodes (9): catalogue module, BestByResult, computeBestBy(), Food, FoodSearchResult, ShelfLife, catalogue test, UNIT_MS (+1 more)
...
Cohesion: 0.24
Nodes (10): POST /api/push/subscribe, POST /api/push/unsubscribe, OfflineBanner component, PushSettings component, ItemRow, i18n m (message resolver), Band, DayBadge component (+2 more)

### Community 89 - "Runtime Dependencies"
Cohesion: 0.24
Nodes (7): FOOD_SEED, FoodSeed, ShelfLifeSeed, seedFoods(), VALID_BASES, VALID_LOCATIONS, VALID_UNITS
...
Cohesion: 0.33
Nodes (5): actions, addPackagedSchema, load(), locationSchema, getOffConfig()
...
Cohesion: 0.33
Nodes (6): POST /api/webauthn/authenticate/options, POST /api/webauthn/authenticate/verify, POST /api/webauthn/register/options, POST /api/webauthn/register/verify, PasskeyEnroll component, PasskeyLogin component
...
Cohesion: 0.33
Nodes (6): autoincrement, name, notNull, primaryKey, type, brand
...
Cohesion: 0.4
Nodes (5): load(), Households list page, Household manage hub page, load(), Invite page
...
- **Why does `devDependencies` connect `Invitations FK Schema (mig)` to `Schema col: custom_name`?**
  _High betweenness centrality (0.014) - this node is a cross-community bridge._
- **Why does `svelte` connect `Invitations FK Schema (mig)` to `Push & Daily-Reminder Cron`?**
