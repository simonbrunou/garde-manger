# Graph Report - garde-manger  (2026-06-01)

## Corpus Check
- 185 files · ~113,074 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2750 nodes · 3563 edges · 286 communities (255 shown, 31 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 68 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `80c35f46`
...
Cohesion: 0.07
Nodes (41): POST(), deleteSubscriptionByEndpoint, saveSubscription, cron module, DailyReminderSummary, runDailyReminders(), secretMatches(), cron test (+33 more)

### Community 1 - "Frontend Lib Imports & Passkeys"
Cohesion: 0.18
Nodes (5): $lib/icons, ./$types, ./$types, ./$types, ./Icon.svelte
...
Cohesion: 0.16
Nodes (14): shelfLives, FOOD_SEED, FoodSeed, ShelfLifeSeed, seedFoods(), VALID_BASES, VALID_LOCATIONS, VALID_UNITS (+6 more)

### Community 7 - "Household Admin CRUD"
Cohesion: 0.20
Nodes (18): load(), (app) layout component, actions, fixActiveHousehold(), setHouseholdCookie(), households module, countAdmins(), createHousehold() (+10 more)

### Community 8 - "Home Inventory Listing"
Cohesion: 0.15
Nodes (21): load(), actions, Groups, load(), Location, activeHouseholdId(), listActive, addCustom() (+13 more)
...
Cohesion: 0.12
Nodes (18): POST /api/push/subscribe, POST /api/push/unsubscribe, BarcodeScanner component, OfflineBanner component, PushSettings component, categoryIcon, i18n m (message resolver), categoryIcon() (+10 more)
...
Cohesion: 0.05
Nodes (53): POST /api/webauthn/authenticate/options, POST /api/webauthn/authenticate/verify, POST /api/webauthn/register/options, POST /api/webauthn/register/verify, clearSessionCookie(), setSessionCookie(), createSession(), invalidateSession() (+45 more)
...
Cohesion: 0.18
Nodes (17): createDb(), runMigrations(), makeDb(), products, makeDb(), makeDb(), pushSubscriptions, makeDb() (+9 more)
...
Cohesion: 0.15
Nodes (12): actions, load(), account page component, listCredentials(), @simplewebauthn/browser, $app/environment, vapidPublicKey, ./$types (+4 more)

### Community 49 - "WebAuthn Endpoints & Session"
Cohesion: 0.16
Nodes (7): $lib/i18n, ./$types, ./$types, ./$types, ./$types, ./$types, $app/state
...
Cohesion: 0.26
Nodes (9): assertConfig(), authenticationOptions(), deleteCredential(), registrationOptions(), User, verifyRegistration(), POST(), POST() (+1 more)
...
Cohesion: 0.27
Nodes (10): invitations, memberships, acceptInvitation(), createInvitation(), InvitationError, randomToken(), revokeInvitation(), sha256() (+2 more)
...
Cohesion: 0.46
Nodes (5): Idea, IDEAS, cook module, ideasForCategory(), cook test
...
Cohesion: 0.18
Nodes (10): dialect, id, prevId, compositePrimaryKeys, foreignKeys, indexes, name, tables (+2 more)
...
Cohesion: 0.24
Nodes (8): ItemRow, dayBadge(), dates tests, NOW, Band, DayBadge component, ItemRow Component, RowItem interface
...
Cohesion: 0.22
Nodes (8): $lib/dates, $lib/server/inventory, ./DayBadge.svelte, aria, consumeId, discardId, swipeActions, destructive
...
Cohesion: 0.29
Nodes (7): Household manage hub actions, ensureAdmin(), acceptInvitation, createInvitation, InvitationError, revokeInvitation, Invite create action
...
Cohesion: 0.33
Nodes (4): statusText, barcode-detector/ponyfill, $lib/barcode, zxing-wasm/reader/zxing_reader.wasm?url
...
Cohesion: 0.17
Nodes (12): DB, credentials, foods, households, inventoryItems, sessions, users, NOW (+4 more)

### Community 261 - "Community 261"
Cohesion: 0.33
Nodes (6): default_location, autoincrement, name, notNull, primaryKey, type

### Community 262 - "Community 262"
Cohesion: 0.33
Nodes (6): keywords_en, autoincrement, name, notNull, primaryKey, type

### Community 263 - "Community 263"
Cohesion: 0.33
Nodes (6): keywords_fr, autoincrement, name, notNull, primaryKey, type
...
Cohesion: 0.33
Nodes (6): name_en, autoincrement, name, notNull, primaryKey, type
...
Cohesion: 0.33
Nodes (6): name_fr, autoincrement, name, notNull, primaryKey, type

### Community 271 - "Community 271"
Cohesion: 0.33
Nodes (6): subtitle_en, autoincrement, name, notNull, primaryKey, type

### Community 272 - "Community 272"
Cohesion: 0.33
Nodes (6): subtitle_fr, autoincrement, name, notNull, primaryKey, type
...
## Knowledge Gaps
- **1766 isolated node(s):** `name`, `private`, `version`, `type`, `packageManager` (+1761 more)
...
- **Why does `columns` connect `Schema col: use_by_date` to `Schema col: food_id`, `Schema col: kind`, `Schema col: location`, `Schema col: effective_date`, `Schema col: notes`, `Schema col: custom_name`, `DB Schema Fragment`, `Inventory-Items FK Schema (mig)`, `Schema col: quantity`, `Community 284`, `Schema col: added_at`, `Schema col: is_estimate`, `Schema col: status`, `Schema col: closed_at`, `Schema col: added_by`, `Schema col: best_by_date`, `Schema col: barcode`?**
  _High betweenness centrality (0.011) - this node is a cross-community bridge._
- **Why does `id` connect `DB Schema Fragment` to `Foods Catalogue Schema (mig)`, `Schema col: joined_at`, `Schema col: expires_at`, `Schema col: added_at`, `Schema col: credential_id`, `DB Schema Fragment`?**
  _High betweenness centrality (0.011) - this node is a cross-community bridge._
- **Why does `columns` connect `Schema col: added_at` to `Schema col: effective_date`, `Schema col: barcode`, `Schema col: best_by_date`, `Schema col: added_by`, `Schema col: closed_at`, `Schema col: custom_name`, `Schema col: food_id`, `Schema col: joined_at`, `Schema col: kind`, `Schema col: location`, `Schema col: notes`, `Schema col: use_by_date`, `Schema col: is_estimate`, `Inventory-Items FK Schema`, `DB Schema Fragment`, `Schema col: quantity`, `Schema col: status`?**
...
- **Should `Foods Catalogue Schema (mig)` be split into smaller, more focused modules?**
